...
41. Bxf2 Qxb1 42. g5 Qf1+ 0-1
  ...
  correctMoveSan: 'Nxd4',          // основной ответ (как в партии)
  points: 1,
  options: ['exd4', 'Nxd4'],
  explanations: {
    'Nxd4': '14...Nxd4 — надёжное и понятное решение: конь встаёт в центр, фигуры развиваются без ослаблений.',
    'exd4': '14...exd4 — смелое, но рискованное решение. Если ты точно посчитал вариант с 15.e5 и нашёл защиту — это заслуживает отдельного разбора.'
  },

  // НОВОЕ: альтернативно правильные ответы, которые требуют доказательства
  altCorrect: [
    {
      san: 'exd4',
      // как подсвечивать этот вариант в списке (жёлтым)
      highlightClass: 'alt-correct',

      // мини-квест: сценарий доказательства
      proofQuest: {
        title: 'Доказательство: 14...exd4',
        // стартуем из позиции текущего момента (т.е. после ходов до index)
        steps: [
          {
            // Анимация: показать продолжение после выбора exd4
            autoplayMoves: ['exd4', 'e5'],
            // потом задаём manual-вопрос
            question: 'Здесь понадобится изобретательная защита. Какая?',
            type: 'manual',
            correctMoveSan: 'Nxe5',
            // после правильного хода — автоматически показать ответ белых
            afterCorrectAutoplayMoves: ['Qxe5']
          },
          {
            question: 'Зачем мы пожертвовали фигуру?',
            type: 'manual',
            correctMoveSan: 'Qc6',
            afterCorrectAutoplayMoves: [] // можно пусто
          }
        ],

        // сколько очков дать, если игрок ДОКАЗАЛ альтернативу (можно 2)
        rewardPoints: 2
      }
    }
  ]
